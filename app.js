...
async function loadMyReports() {
    ...
    if (snap.empty) {
        container.innerHTML = "<div class='card'><p>No entries found yet.</p></div>";
        return;
    }
...
async function loadAdminPanel() {
    ...
    if (!tableBody) return;
    tableBody.innerHTML = "<tr><td colspan='3'>Syncing Records...</td></tr>";
    ...
    for (const uDoc of usersSnap.docs) {
        ...
        bodyHtml += "<tr><td style='padding:10px;'>" + u.name + "</td><td>" + u.level + "</td><td>" + score + "</td></tr>";
    }
